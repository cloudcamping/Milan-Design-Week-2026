...
const EVENTS = [
  ...
  { id:"b-zeekr", name:"Zeekr", exhibition:"The Art of Connection", venue:"Brera Design District", address:"Brera (Venue TBC)", district:"Brera", coords:[45.4720,9.1870], pin:"Z", description:"Zeekr 7GT-Präsentation mit immersiver Designinstallation.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-carlhansen", name:"Carl Hansen & Søn", exhibition:"Balanced Principles", venue:"Carl Hansen Showroom", address:"Via Solferino 11, 3. OG", district:"Brera", coords:[45.4760,9.1855], pin:"C", description:"Hans-Wegner-Hommage.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-kerakoll", name:"Kerakoll × Du Pasquier / Sowden", exhibition:"1.500 Farben", venue:"Via Solferino", address:"Via Solferino", district:"Brera", coords:[45.4770,9.1860], pin:"K", description:"Abstrakte urbane Bühne mit 1.500 Farben. Fassade und Innenraum als Gesamtkunstwerk.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-tacchini", name:"Tacchini", exhibition:"Neuer Showroom", venue:"Tacchini", address:"Largo Treves 5", district:"Brera", coords:[45.4770,9.1870], pin:"T", description:"Showroom-Eröffnung.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-marsotto", name:"Marsotto edizioni × nendo", exhibition:"Portal-Skulptur in Marmor", venue:"Marsotto", address:"Largo Treves 2", district:"Brera", coords:[45.4768,9.1868], pin:"N", description:"Portal-Skulptur in Marmor.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-boffi", name:"Boffi", exhibition:"EuroCucina-Jahr", venue:"Boffi Showroom", address:"Via Solferino 11", district:"Brera", coords:[45.4760,9.1857], pin:"B", description:"Küchen- und Bad-Showroom (EuroCucina-Jahr).", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-davidegroppi", name:"Davide Groppi", exhibition:"Neuer Showroom", venue:"Davide Groppi", address:"Via Manzoni 38", district:"Brera", coords:[45.4715,9.1925], pin:"D", description:"Licht-Designer-Showroom-Eröffnung.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-lacividina", name:"LaCividina", exhibition:"Atrio Calmo", venue:"LaCividina", address:"Via Manzoni 41", district:"Brera", coords:[45.4715,9.1937], pin:"L", description:"Rauminstallation.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-casagessi", name:"Casa Gessi", exhibition:"Haute Culture Longevity Ritual", venue:"Casa Gessi", address:"Via Manzoni 16a", district:"Brera", coords:[45.4695,9.1910], pin:"G", description:"Luxusbad-Erlebnis.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-alessi-brera", name:"Alessi (Brera)", exhibition:"Showroom", venue:"Alessi", address:"Via Manzoni 14", district:"Brera", coords:[45.4693,9.1908], pin:"A", description:"Alessi Showroom + Il Tornitore Matto bei Superstudio Maxi.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  ...
  { id:"b-seletti", name:"Seletti", exhibition:"Neuheiten", venue:"Seletti Showroom", address:"Brera", district:"Brera", coords:[45.4720,9.1873], pin:"S", description:"Neuheiten.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-talenti", name:"Talenti", exhibition:"Outdoor-Möbel", venue:"Talenti", address:"Via Manzoni 11", district:"Brera", coords:[45.4690,9.1905], pin:"T", description:"Outdoor-Kollektion.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-modulnova", name:"Modulnova", exhibition:"Küchensysteme", venue:"Modulnova", address:"Corso Garibaldi 99", district:"Brera", coords:[45.4790,9.1862], pin:"M", description:"Küchensysteme.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-dieffebi", name:"Dieffebi", exhibition:"Büromöbel", venue:"Dieffebi", address:"Via Milazzo 8", district:"Brera", coords:[45.4800,9.1850], pin:"D", description:"Büromöbeldesign.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-walterknoll", name:"Walter Knoll", exhibition:"Luxusmöbel", venue:"Walter Knoll", address:"Brera Design District", district:"Brera", coords:[45.4725,9.1875], pin:"W", description:"Deutsche Premium-Marke.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-missoni", name:"Missoni Home / RODA|MISSONI", exhibition:"Neue Boutique", venue:"Missoni Home", address:"Via Solferino 9", district:"Brera", coords:[45.4755,9.1850], pin:"M", description:"Missoni-Home-Boutique-Opening.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"b-mca", name:"MCA / Mario Cucinella Architects", exhibition:"Città delle Idee", venue:"MCA", address:"Via Solferino 28", district:"Brera", coords:[45.4790,9.1860], pin:"M", description:"3D-gedruckte modulare Stadt für Corriere della Sera / Living / Abitare.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  // Brera Länderpavillons fehlend
  { id:"b-spain", name:"Spanien / Barcelona", exhibition:"Inspired in Barcelona: Materia Prima", venue:"Chiesa del Carmine", address:"Via del Carmine 10", district:"Brera", coords:[45.4740,9.1850], pin:"🇪🇸", description:"Sensorische Reise durch Brot und Olivenöl als Designmetaphern (Queralt Suau + Andreu Carulla).", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  ...
  { id:"d-luceplan", name:"Luceplan", exhibition:"Showroom-Neuheiten", venue:"Luceplan", address:"Corso Monforte", district:"Durini", coords:[45.4652,9.2022], pin:"L", description:"Leuchten-Novitäten.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-nemo", name:"Nemo", exhibition:"Leuchten-Neuheiten", venue:"Nemo Showroom", address:"Corso Monforte", district:"Durini", coords:[45.4654,9.2024], pin:"N", description:"Leuchten-Neuheiten.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-fontanaarte", name:"Fontana Arte", exhibition:"Historische + neue Kollektion", venue:"Fontana Arte", address:"Corso Monforte", district:"Durini", coords:[45.4656,9.2026], pin:"F", description:"Klassiker und Novitäten.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-dg", name:"Dolce & Gabbana Casa", exhibition:"Live-Performance Home-Kollektion", venue:"D&G Casa", address:"Via Durini / Corso Venezia 7", district:"Durini", coords:[45.4680,9.1985], pin:"D", description:"Home-Kollektion mit Live-Performance.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-versace", name:"Versace Home", exhibition:"Milano Moda Design", venue:"Versace Home", address:"Via Durini 11", district:"Durini", coords:[45.4625,9.1965], pin:"V", description:"Neue Home-Kollektion.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-natuzzi", name:"Natuzzi", exhibition:"Polstermöbel-Neuheiten", venue:"Natuzzi", address:"Via Durini", district:"Durini", coords:[45.4625,9.1970], pin:"N", description:"Polstermöbel.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-technogym", name:"Technogym", exhibition:"Video-Installation", venue:"Technogym", address:"Via Durini", district:"Durini", coords:[45.4627,9.1972], pin:"T", description:"Fitness trifft Design.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-cappellini", name:"Cappellini", exhibition:"Zeitgenössische Klassiker", venue:"Cappellini (neuer Showroom)", address:"Via Borgogna 8", district:"Durini", coords:[45.4630,9.1940], pin:"C", description:"Showroom-Neueröffnung.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-knoll", name:"Knoll", exhibition:"Showroom + Neuheiten", venue:"Knoll", address:"Piazza Bertarelli 2", district:"Durini", coords:[45.4625,9.1925], pin:"K", description:"Neue Kollektionen.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-venini", name:"Venini", exhibition:"Muranoglas-Leuchten", venue:"Venini", address:"Via Durini 27", district:"Durini", coords:[45.4620,9.1975], pin:"V", description:"Neuer Raum für Muranoglas.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-bonaldo", name:"Bonaldo", exhibition:"Showroom-Neueröffnung", venue:"Bonaldo", address:"Via Larga 16", district:"Durini", coords:[45.4605,9.1950], pin:"B", description:"Neuer Showroom.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-cattelan", name:"Cattelan Italia", exhibition:"Designmöbel", venue:"Cattelan Italia", address:"Via Larga 23", district:"Durini", coords:[45.4605,9.1945], pin:"C", description:"Italienische Designmöbel.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-emu", name:"Emu", exhibition:"Outdoor-Möbel (neuer Showroom)", venue:"Emu", address:"Corso Monforte", district:"Durini", coords:[45.4653,9.2023], pin:"E", description:"Outdoor-Neuheiten.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-depadova", name:"De Padova", exhibition:"Boffi|De Padova", venue:"De Padova", address:"Corso Monforte", district:"Durini", coords:[45.4655,9.2025], pin:"D", description:"Ikonische Designmöbel.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-kvadrat", name:"Kvadrat × Magniberg × NM3", exhibition:"Textilinstallation", venue:"Hinterhof Flos-Showroom", address:"Corso Monforte (Flos Hof)", district:"Durini", coords:[45.4657,9.2027], pin:"Q", description:"Textilneuheiten.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-arper", name:"Arper", exhibition:"Sitz- und Einrichtungssysteme", venue:"Arper", address:"Via Pantano 30", district:"Durini", coords:[45.4630,9.1910], pin:"A", description:"Sitzsysteme.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-visionnaire", name:"Visionnaire", exhibition:"High-End-Einrichtung", venue:"Visionnaire", address:"Piazza Cavour 3", district:"Durini", coords:[45.4730,9.1897], pin:"V", description:"Luxusmöbel.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-rochebobois", name:"Roche Bobois", exhibition:"Luxusmöbel", venue:"Roche Bobois", address:"Via Cavallotti 14", district:"Durini", coords:[45.4625,9.1980], pin:"R", description:"Französischer Luxusmöbelhersteller.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-gallotti", name:"Gallotti & Radice", exhibition:"Glas-/Metallmöbel", venue:"Gallotti & Radice", address:"Via Cavallotti", district:"Durini", coords:[45.4623,9.1978], pin:"G", description:"Glas- und Metallmöbel.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-caccaro", name:"Caccaro", exhibition:"Schranksysteme", venue:"Caccaro", address:"Via Flavio Baracchini 9", district:"Durini", coords:[45.4620,9.1935], pin:"C", description:"Schranksysteme.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-edra", name:"Edra", exhibition:"Experimentelle Polstermöbel", venue:"Edra", address:"Via Durini", district:"Durini", coords:[45.4628,9.1968], pin:"E", description:"Avantgarde-Polstermöbel.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-cimento", name:"CIMENTO × Patricia Urquiola", exhibition:"Eingangsinstallation", venue:"Convey Building", address:"Via Senatore 10", district:"Durini", coords:[45.4610,9.1905], pin:"U", description:"Material-Inszenierung von Patricia Urquiola.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-slide", name:"Slide × Krillmat", exhibition:"Kreislaufwirtschafts-Projekt", venue:"Starbucks Milano Durini", address:"Via Durini 28", district:"Durini", coords:[45.4625,9.1972], pin:"♻", description:"Circular-Design-Projekt.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-preciosa-babila", name:"Preciosa", exhibition:"Kronleuchter im öffentlichen Raum", venue:"Piazza San Babila", address:"Piazza San Babila", district:"Durini", coords:[45.4647,9.1972], pin:"✨", description:"Kronleuchter-Installation.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"d-progettocmr", name:"Progetto CMR", exhibition:"CAMERA — Inside the Lens", venue:"Piazza San Babila", address:"Piazza San Babila", district:"Durini", coords:[45.4644,9.1970], pin:"📷", description:"Mikroarchitektur inspiriert vom Kameraobjektiv.", days:[20,21,22,23,24,25,26], reservation:{required:false} },

  // ===== TORTONA (fehlend — 17) =====
  { id:"t-italdesign", name:"Italdesign", exhibition:"Essere il Progetto", venue:"Mehrere Standorte", address:"Tortona (verteilt)", district:"Tortona", coords:[45.4518,9.1700], pin:"I", description:"Honda NSX Tribute, Nissan GT-R50, Pop.Up-Next-Konzept, Robotik.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-zeekrdesign", name:"Zeekr Design", exhibition:"Art of Connection", venue:"Opificio 31", address:"Via Tortona 31", district:"Tortona", coords:[45.4511,9.1693], pin:"Z", description:"Zeekr 7GT-Fahrzeugpräsentation.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-haier", name:"Haier", exhibition:"Inside the Experience", venue:"Tortona", address:"Tortona (Venue TBC)", district:"Tortona", coords:[45.4520,9.1710], pin:"H", description:"Technologie-Mensch-Wohnraum-Reflexion.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-boodt", name:"Hans Boodt Mannequins", exhibition:"Rebel", venue:"Opificio 31", address:"Via Tortona 31", district:"Tortona", coords:[45.4514,9.1693], pin:"H", description:"3D-gescannte realistische Schaufensterpuppen.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-archiproducts", name:"Archiproducts Milano × Studio Pepe", exhibition:"FÒCO", venue:"Tortona", address:"Tortona", district:"Tortona", coords:[45.4515,9.1705], pin:"A", description:"Interior-Kapitel der Archiproducts-Plattform.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-next125", name:"Next125 × Ankon Mitra", exhibition:"Deutsche Premium-Küche", venue:"Superstudio Design", address:"Via Tortona 27", district:"Tortona", coords:[45.4516,9.1697], pin:"N", description:"Deutsche Premium-Küchenmarke + indischer Architekt.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-honda", name:"Honda", exhibition:"Studenten-Workshops mit KI", venue:"SuperNova, Superstudio Più", address:"Via Tortona 27", district:"Tortona", coords:[45.4517,9.1696], pin:"H", description:"KI-gestützte Design-Workshops.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-lovegrove", name:"Ross Lovegrove", exhibition:"Gabo 2.0", venue:"SuperNova, Superstudio Più", address:"Via Tortona 27", district:"Tortona", coords:[45.4516,9.1694], pin:"R", description:"Skulpturales Designobjekt.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-vimar", name:"Vimar × Giulio Iacchetti", exhibition:"230 VOLT-i", venue:"SuperNova, Superstudio Più", address:"Via Tortona 27", district:"Tortona", coords:[45.4515,9.1695], pin:"V", description:"Steckdosen-/Schalterinstallation.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-toyoito", name:"Toyo Ito et al.", exhibition:"One Earth: House of the Heart", venue:"SuperNova, Superstudio Più", address:"Via Tortona 27", district:"Tortona", coords:[45.4516,9.1698], pin:"🏠", description:"Internationaler Kinderarchitektur-Workshop mit Modellen von 100 japanischen Kindern + Architekten (Kazuyo Sejima, Sou Fujimoto u.a.).", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-lousy", name:"Lousy Auber", exhibition:"Keep Your Bubble", venue:"Superstudio Village", address:"Via Pericle Negrotto 59 (Bovisa)", district:"Tortona", coords:[45.5007,9.1702], pin:"🎈", description:"Aufblasbare interaktive Struktur aus wiederverwendeten Heißluftballon-Stoffen.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-fossati", name:"Francesca Fossati", exhibition:"Fili d'Anima", venue:"Superstudio Village", address:"Via Pericle Negrotto 59 (Bovisa)", district:"Tortona", coords:[45.5008,9.1703], pin:"F", description:"Modulare handgefertigte sardische Teppiche (Pibiones-Technik).", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-graphicdays", name:"Graphic Days", exhibition:"Festival-Debüt bei MDW (10-Jahr-Jubiläum)", venue:"Superstudio Village", address:"Via Pericle Negrotto 59 (Bovisa)", district:"Tortona", coords:[45.5009,9.1704], pin:"G", description:"Turiner Grafikfestival + Posterheroes-Wettbewerb.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-wewilldesign", name:"We Will Design", exhibition:"Hello Darkness", venue:"BASE Milano", address:"Via Bergognone 34", district:"Tortona", coords:[45.4538,9.1681], pin:"W", description:"80+ Designer aus 23 Ländern erforschen Dunkelheit als Raum der Möglichkeiten.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-lecannibale", name:"Le Cannibale", exhibition:"DJ-Sets (BASE Hof)", venue:"BASE Milano Hof", address:"Via Bergognone 34", district:"Tortona", coords:[45.4537,9.1682], pin:"🎧", description:"Freie DJ-Sets 21.–25.4. (Quantic, Batu, Coca Puma).", days:[21,22,23,24,25], reservation:{required:false} },
  { id:"t-saffi", name:"Officine Saffi × Hannes Peer", exhibition:"Terrain", venue:"BASE Milano", address:"Via Bergognone 34", district:"Tortona", coords:[45.4536,9.1680], pin:"◾", description:"Keramik-Wandinstallation.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-rca", name:"RCA × Lemonot", exhibition:"Live Camp-ing", venue:"BASE Terrasse", address:"Via Bergognone 34", district:"Tortona", coords:[45.4539,9.1683], pin:"R", description:"20 Londoner Studierende bauen temporäre Wohngemeinschaft.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  // Tortona Länderpavillons
  { id:"t-thailand", name:"Thailand", exhibition:"Slow Hand Design", venue:"SuperNova, Superstudio Più", address:"Via Tortona 27", district:"Tortona", coords:[45.4518,9.1696], pin:"🇹🇭", description:"25 thailändische Designer zwischen Tradition und Innovation.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-ecuador", name:"Ecuador", exhibition:"IN BETWEEN", venue:"Via Tortona 14", address:"Via Tortona 14", district:"Tortona", coords:[45.4523,9.1725], pin:"🇪🇨", description:"8 Designer. Amazonasfasern, Myzel-Biomaterialien, Naturfarben.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"t-france", name:"Frankreich", exhibition:"Le Design Défilé", venue:"Superstudio", address:"Via Tortona 27", district:"Tortona", coords:[45.4519,9.1697], pin:"🇫🇷", description:"53 Kreationen von 28 französischen Häusern (Jakob + MacFarlane).", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  ...
  { id:"5-yasmine", name:"Richard Yasmine", exhibition:"Vessels of the Intangible", venue:"5VIE Hub", address:"Via Olona 4 (5VIE Hub)", district:"5VIE", coords:[45.4616,9.1714], pin:"R", description:"Beleuchtungs- / Kunstkollektion.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  ...
  // ===== ISOLA (fehlend — 5) =====
  { id:"i-algrantilab", name:"AlgrantiLAB", exhibition:"Recycling-Möbel", venue:"Isola-Quartier", address:"Isola", district:"Isola", coords:[45.4850,9.1912], pin:"A", description:"Möbel aus recycelten Materialien.", days:[20,21,22,23,24,25,26], reservation:{required:true, link:"https://isola.design/rsvp-isoladesignfestival2026", note:"Festival-RSVP"} },
  { id:"i-rivariva", name:"Boiserie Riva / RivaViva", exhibition:"Wellness-Architektur", venue:"Isola Showroom", address:"Isola", district:"Isola", coords:[45.4852,9.1915], pin:"R", description:"Verfeinerte Handwerkskunst mit Bad/Wellness-Fokus.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"i-garbelotto", name:"Garbelotto Studio Milano", exhibition:"Parkett-Showroom", venue:"Isola Showroom", address:"Isola", district:"Isola", coords:[45.4854,9.1918], pin:"G", description:"100 % Made-in-Italy Parkett-Showroom.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"i-ithra", name:"Ithra", exhibition:"Kollektivausstellung", venue:"Fabbrica Sassetti", address:"Via Filippo Sassetti 31", district:"Isola", coords:[45.4873,9.2034], pin:"I", description:"Kollektiv-Showcase.", days:[20,21,22,23,24,25,26], reservation:{required:true, link:"https://isola.design/rsvp-isoladesignfestival2026", note:"Festival-RSVP"} },
  { id:"i-designtech", name:"Designtech", exhibition:"Urban Collective Project", venue:"Isola (verteilte Pavillons)", address:"Isola", district:"Isola", coords:[45.4848,9.1910], pin:"D", description:"Digitale Fertigung.", days:[20,21,22,23,24,25,26], reservation:{required:false} },

  // ===== CENTRO (fehlend — 5) =====
  { id:"c-cavalli", name:"Roberto Cavalli", exhibition:"Mediterranean Heritage", venue:"Tommasi Milano", address:"Piazza Giovine Italia", district:"Centro", coords:[45.4620,9.1730], pin:"R", description:"24-Stunden-Immersive-Experience (8–2 Uhr) + Party bei Torre Branca.", days:[20,21,22,23,24,25,26], reservation:{required:false, note:"RSVP Party"} },
  { id:"c-eliesaab", name:"Elie Saab Maison", exhibition:"Una Notte a Milano", venue:"Palazzo-Venue", address:"Palazzo-Venue (TBC)", district:"Centro", coords:[45.4670,9.1890], pin:"E", description:"Italienisches 1970er-Kino als Kulisse. Debüt Mascagni-Sofa + Onda-Sessel (CD Carlo Colombo).", days:[20,21,22,23,24,25,26], reservation:{required:false, note:"RSVP empfohlen"} },
  ...
  { id:"pv-glasitalia", name:"Glas Italia", exhibition:"Neuer Showroom", venue:"Glas Italia", address:"Corso Venezia 18", district:"Porta Venezia", coords:[45.4683,9.1978], pin:"G", description:"Showroom-Neueröffnung.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  ...
  { id:"pn-studioazzurro2", name:"Studio Azzurro (INTERNI MATERIAE)", exhibition:"Light Our Fire", venue:"Urban Up/Unipol", address:"Via De Castillia 23", district:"Isola", coords:[45.4843,9.1906], pin:"◉", description:"Kinetische Leuchtfassade. 37 m Durchmesser, 492 Paneele.", days:[20,21,22,23,24,25,26], reservation:{required:false} },

  // ===== INTERNI MATERIAE — Università Statale (fehlend) =====
  { id:"stat-vitra", name:"VitrA × Snøhetta", exhibition:"Ceramics Forged in Light", venue:"Università Statale, Cortile", address:"Via Festa del Perdono 7", district:"INTERNI Materiae", coords:[45.4604,9.1971], pin:"V", description:"Keramik-Recycling und Nachhaltigkeit.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"stat-uniqlo", name:"Uniqlo × Thirtyone Design", exhibition:"Goodbye Discomfort", venue:"Università Statale, Cortile", address:"Via Festa del Perdono 7", district:"INTERNI Materiae", coords:[45.4605,9.1969], pin:"U", description:"Wohlbefinden und Komfort als Designthemen.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"stat-mutti", name:"Mutti", exhibition:"20.000 Dosen", venue:"Università Statale, Cortile", address:"Via Festa del Perdono 7", district:"INTERNI Materiae", coords:[45.4606,9.1970], pin:"M", description:"20.000 Dosen als Kreislaufwirtschafts-Installation.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"stat-orlinski", name:"Fidenza Village / Richard Orlinski", exhibition:"Wild Kong (3 m)", venue:"Università Statale, Cortile", address:"Via Festa del Perdono 7", district:"INTERNI Materiae", coords:[45.4604,9.1968], pin:"🦍", description:"3-Meter-Skulptur in knallroter Popästhetik.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"stat-gibus", name:"Gibus × Meneghello Paolelli", exhibition:"365", venue:"Università Statale, Cortile", address:"Via Festa del Perdono 7", district:"INTERNI Materiae", coords:[45.4605,9.1968], pin:"G", description:"Dynamisches Outdoor-Living.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"stat-domyn", name:"Domyn × Veolia", exhibition:"Infinity", venue:"Università Statale, Cortile della Farmacia", address:"Via Festa del Perdono 7", district:"INTERNI Materiae", coords:[45.4607,9.1969], pin:"∞", description:"KI + generative Musik.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"stat-treemme", name:"Rubinetterie Treemme", exhibition:"Ad Aquam 2026", venue:"Università Statale, Cortile", address:"Via Festa del Perdono 7", district:"INTERNI Materiae", coords:[45.4605,9.1967], pin:"💧", description:"Wasserbewusstsein.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"stat-pasquale", name:"Pasquale Bruni", exhibition:"Schmuck × Architektur", venue:"Università Statale, Loggiato West", address:"Via Festa del Perdono 7", district:"INTERNI Materiae", coords:[45.4604,9.1966], pin:"💍", description:"Schmuck trifft Architektur (Christoph Radl + Eugenia Bruni).", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  { id:"stat-mcz", name:"MCZ Group", exhibition:"Multisensorisches Klimaerlebnis", venue:"Università Statale, Cortile", address:"Via Festa del Perdono 7", district:"INTERNI Materiae", coords:[45.4606,9.1966], pin:"M", description:"Multisensorisch.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
  ...
  { id:"x-netherlands", name:"Niederlande", exhibition:"Civicity", venue:"Nieuwe Instituut Rotterdam + cheFare + NL Botschaft", address:"Milano", district:"Featured", coords:[45.4700,9.1850], pin:"🇳🇱", description:"Design öffentlicher Räume für Gemeinschaftsqualität.", days:[20,21,22,23,24,25,26], reservation:{required:false} },
